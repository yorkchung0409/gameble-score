    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-2 mb-6">
      {members.map((m) => {
        ...
        return (
          ...
          >
            <div
              className="text-sm font-semibold mb-0.5 text-center truncate w-full"
              style={{ color: '#f0f0e8' }}
              title={m.userName}
            >
              {m.userName}
              {isMe && (
                <span className="text-[10px] ml-0.5" style={{ color: '#d4af37' }}>
                  （我）
                </span>
              )}
            </div>
            <div className="text-xs mb-1.5" style={{ color: '#c9c9bc' }}>
      ...
      >
        <div className="text-sm font-semibold mb-0.5" style={{ color: '#e8c96a' }}>
          茶水费
        </div>
        <div className="text-xs mb-1.5" style={{ color: '#c9c9bc' }}>
